...
public class LinkedListTest {
    ...
    @Test
    public void whenUsingIncreaseSize_verifySizeIncreases(){
        LinkedList<String> list = new LinkedList<>();
    ...
    @Test
    public void removeWorksForOneNode() throws NotNullAllowedException, BadIndexException {
        LinkedList<String> list = new LinkedList<>();
        list.addAtHead("1");
    ...
    @Test
    public void removeWorksForTwoNodes() throws NotNullAllowedException, BadIndexException {
        LinkedList<String> list = new LinkedList<>();
        list.addAtHead("1");
        list.addAtHead("2");
    ...
    @Test
    public void RemoveAllWithValueWorksForOneNode() throws NotNullAllowedException {
        LinkedList<String> list = new LinkedList<>();
        list.addAtHead("1");
        list.addAtHead("2");
        list.addAtHead("3");
    ...
    @Test
    public void RemoveAllWithValueWorksForTwoNodes() throws NotNullAllowedException {
        LinkedList<String> list = new LinkedList<>();
        list.addAtHead("1");
        list.addAtHead("2");
        list.addAtHead("2");
